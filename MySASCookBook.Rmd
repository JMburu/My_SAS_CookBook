---
title: "My SAS CookBook."
author: "James .M. Wanja."
date: 'Last compiled on: `r format(Sys.Date(), format="%B %d, %Y")`.'
output: github_document
header-includes:
- \usepackage{xcolor,soul,hyperref,cite,graphicx,color,amsmath,pdfpages}
- \definecolor{darkblue}{rgb}{0.5,0,0.5}
- \definecolor{lightgreen}{rgb}{0.8,0.9,0.0}
- \setulcolor{darkblue}
...
```{r , eval=FALSE,comment=NA,warning=FALSE}
===============================================          ======  */
